...
## Requirements:
Recent masOS with python3 installed. [https://docs.python-guide.org/starting/install3/osx/](python3 official macOS install doc). I recommend using the official python3 macOS install, I had issues building when building with homebrew installed python3.
